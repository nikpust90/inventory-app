...
2. Откройте Putty
3. Введите данные:
   - Host Name: `45.155.207.231`
   - Port: `22`
   - Connection type: `SSH`
4. Нажмите "Open"
5. Введите логин: `root`
6. Введите пароль: `3acf0371f6dd58!`
...
Если возникают проблемы с CORS при обращении к API `http://45.155.207.231:8000`, 
