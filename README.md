...
Система инвентаризации со складами и документами: мобильный Android-клиент и веб-интерфейс с интеграциями во внешние сервисы.
...
- Интеграции с 1С, Bitrix24, автомобильным API и Яндекс.Диском
